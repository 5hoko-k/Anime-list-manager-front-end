        ...
        <div className="flex mx-auto w-3/4 h-full">
          <aside className="bg-bushGreen-shades-400 p-3 w-1/3">
            ...
            <p>
              ...
              tempora, delectus qui reiciendis obcaecati natus at aliquid
              provident nihil ipsa asperiores officia veniam? Tempore esse
              impedit architecto reprehenderit harum atque?
            </p>
          </aside>
          ...
          <main className="bg-bushGreen-shades-200 w-2/3">
            <div className="hover:bg-green-800">
              <button
                className="hover:bg-green-900 p-2"
            ...
            <div className="p-3">
              <p>
                ...
                Facilis architecto dicta impedit ex accusantium delectus? Vel
                nam minima provident corporis nisi, perferendis blanditiis
                eligendi rerum asperiores maiores veritatis dolorem aspernatur.
              </p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi,
                tempora, delectus qui reiciendis obcaecati natus at aliquid
